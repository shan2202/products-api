...
SQLALCHEMY_DATABASE_URL = "sqlite:///./productapp.db"
...
def create_default_admin_user():
    db = SessionLocal()
    hashed_password = get_password_hash(os.environ.get('ADMINPASSWORD'))
    db_user = Users(username="admin", fullname="admin", email="admin@admin.com", hashed_password=hashed_password,
